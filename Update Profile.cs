...
It builds a unique filename using the tenant ID — so it becomes something like 3_profile.jpg. Then it saves the actual image file into the wwwroot/uploads folder. 
